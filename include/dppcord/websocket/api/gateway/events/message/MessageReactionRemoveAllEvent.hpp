/**
 * @file MessageReactionRemoveAllEvent.hpp
...
#ifndef MESSAGEREACTIONREMOVEALLEVENT_HPP
#define MESSAGEREACTIONREMOVEALLEVENT_HPP

#include "dppcord/websocket/api/gateway/events/BaseEvent.hpp"

namespace dppcord
{
class MessageReactionRemoveAllEvent : public BaseEvent<nlohmann::json>
{
