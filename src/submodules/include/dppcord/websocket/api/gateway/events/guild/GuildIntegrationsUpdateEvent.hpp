/**
 * @file GuildIntegrationsUpdateEvent.hpp
...
#ifndef GUILDINTEGRATIONSUPDATEEVENT_HPP
#define GUILDINTEGRATIONSUPDATEEVENT_HPP
...
namespace dppcord
{
class GuildIntegrationsUpdateEvent : public BaseEvent<Guild>
{
