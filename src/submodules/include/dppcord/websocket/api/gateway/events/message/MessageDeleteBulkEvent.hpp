/**
 * @file MessageDeleteBulkEvent.hpp
...
#ifndef MESSAGEDELETEBULKEVENT_HPP
#define MESSAGEDELETEBULKEVENT_HPP

#include "dppcord/websocket/api/gateway/events/BaseEvent.hpp"

namespace dppcord
{
class MessageDeleteBulkEvent : public BaseEvent<nlohmann::json>
{
