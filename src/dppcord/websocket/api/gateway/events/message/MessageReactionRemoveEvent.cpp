...
#include "dppcord/websocket/api/gateway/events/message/MessageReactionRemoveEvent.hpp"
...
namespace dppcord
{
void MessageReactionRemoveEvent::proc(const nlohmann::json &eventPacket)
{
    //todo
    std::cout << "MessageReactionRemoveEvent proc\n";
